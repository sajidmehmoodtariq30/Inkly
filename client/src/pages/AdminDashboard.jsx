...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-300 bg-white shadow-lg border-r border-gray-200 flex flex-col`}>        {/* Logo Section */}
        ...
        <nav className="flex-1 p-4">
          ...
          <div className="mb-4">
            <Link
              to="/"
              className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors border border-gray-200"
            >
          ...
          <ul className="space-y-2">
            {sidebarItems.map((item) => {
              ...
              return (
                <li key={item.id}>
                  <button
                    onClick={() => setActivePage(item.id)}                    className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                      activePage === item.id 
        ...
        {/* Admin Profile Section */}        <div className="p-4 border-t border-gray-200">
